...
[] prefers-color-scheme [X] mobile menu [X] sitemap [X] robots [X] tailwind [X]
seo [X] mdx [X] react [X] vercel analytics [X] card image clickable [X] mobile
height 100% [] remove astro-embed [] search [] photo gallery [] suscribe []
contact form
